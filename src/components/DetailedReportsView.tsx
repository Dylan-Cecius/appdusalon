    ...
    <div className="space-y-4 sm:space-y-6 p-4 sm:p-0">
          ...
          <div className="w-full">
            ...
            >
              <div className="flex items-center space-x-2 min-h-[44px]">
                <RadioGroupItem value="all" id="all-detailed" className="h-5 w-5" />
                <Label htmlFor="all-detailed" className="cursor-pointer text-sm sm:text-base">Tous</Label>
              </div>
              <div className="flex items-center space-x-2 min-h-[44px]">
                <RadioGroupItem value="cash" id="cash-detailed" className="h-5 w-5" />
                <Label htmlFor="cash-detailed" className="cursor-pointer text-sm sm:text-base">Cash</Label>
              </div>
              <div className="flex items-center space-x-2 min-h-[44px]">
                <RadioGroupItem value="card" id="card-detailed" className="h-5 w-5" />
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        <Card className="p-4 sm:p-6 text-center">
          ...
          <p className="text-sm sm:text-base text-muted-foreground">Chiffre d'Affaires Total</p>
        </Card>
        ...
        <Card className="p-4 sm:p-6 text-center">
          ...
          <p className="text-sm sm:text-base text-muted-foreground">Total Transactions</p>
        </Card>
        ...
        {paymentFilter === 'all' && (
          <Card className="p-4 sm:p-6 text-center">
            ...
            <p className="text-sm sm:text-base text-muted-foreground mt-2">Répartition Paiements</p>
          </Card>
        )}
      </div>
      ...
      <Card className="p-4 sm:p-6">
        <h4 className="text-base sm:text-lg font-semibold mb-4">
          ...
          <span className="block sm:inline text-xs sm:text-sm text-muted-foreground sm:ml-2 mt-1 sm:mt-0">
          ...
          <Table className="min-w-[600px]">
            <TableHeader>
              <TableRow>
                ...
                <TableHead className="text-center text-sm sm:text-base">Trans.</TableHead>
                {(paymentFilter === 'all' || paymentFilter === 'cash') && (
                  <TableHead className="text-right text-sm sm:text-base">Cash</TableHead>
                )}
                {(paymentFilter === 'all' || paymentFilter === 'card') && (
                  <TableHead className="text-right text-sm sm:text-base">Bancontact</TableHead>
                )}
                <TableHead className="text-right text-sm sm:text-base">Total</TableHead>
              </TableRow>
            </TableHeader>
            <TableBody>
